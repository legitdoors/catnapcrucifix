...
local assets = {
    Repentance = LoadCustomInstance("https://github.com/legitdoors/catnapcrucifix/blob/main/cruci%20halooweeen.rbxm"),
...
warn("Crucifix Everything script : by .vynixu and Curious Crucifix by lloydgarmadon43") -- I feel like this is necessary
